            ...
            <div className='flex h-dvh w-dvw flex-col items-center justify-center gap-2 bg-gray-900 p-2 text-gray-200'>
                ...
                <div className='flex h-full w-full flex-col justify-center gap-2 rounded-md md:flex-row'>
                    ...
                    <div className='flex h-full w-full items-center justify-start rounded-md bg-gray-800 pl-16 md:justify-center md:p-2'>
                        ...
                        <ul className='ulHover list-disc space-y-4 font-bold md:text-3xl'>
                            <li className=' fadeanim hover:text-blue-600'><a href='https://smoriginals-river.onrender.com' target='_blank'>Instagram Mini App</a></li>
                    ...
                    <div className='flex h-full w-full items-center justify-start rounded-md bg-gray-800 pl-16 md:justify-center md:p-2'>
                        <ul className='list-disc space-y-4 font-bold md:text-3xl'>
                            <li className='fadeanim hover:text-blue-600'><a href='https://smoriginals.github.io/dropdown' target='_blank'>Regex Based Search</a></li>
